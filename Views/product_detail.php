            ...
            <div class="cs-flex">
               <div class="cs-flex cs-col-lg-9 cs-wrap product-detail-left">
                  <div class="cs-col-lg-5 left-child">
                     ...
                     <div class="cs-flex flex-content-center" style="border-top: 1px #CCC solid; text-align: justify; line-height: 25px; margin-top: 10px; margin-bottom: 20px; padding-top: 10px;"> <i itemprop="description"><?php echo $prod[0]['description'] ?></i> </div>
                  </div>
                  <div class="cs-col-lg-7 mb-20 right-child">
                     ...
                     <div class="mt-10 cs-flex" style="width: 100%;">
                        <div style="line-height: 28px;">
                           ...
                           <div style="float: left;"> <span> Tình trạng:</span> <span class="status-display" status="0">
                           <span <?php if($prod[0]['flag'] == 0) : ?> style="color: red; font-weight: 600">Ngừng kinh doanh  Đang kinh doanh  </span>
                           <span <?php else: ?> style="color: green; font-weight: 600">   Đang kinh doanh  </span>
                           </span>
                           <?php endif ?>
                            </div>
                     ...
                     <div class="title-cm mt-10 cm-red">
                        <span class="cm-red font-s-25 product-price" itemprop="offers" itemscope itemtype="http://schema.org/Offer" price="<?php echo $prod[0]['price'] ?>">
                           <span itemprop="price" class="cm-red" content="<?php echo $prod[0]['price'] ?>"><?php echo $prod[0]['price'] ?></span><span itemprop="priceCurrency" class="cm-red" content="VND">đ</span> 
                           <meta itemprop="price" content="<?php echo $prod[0]['price'] ?>">
                  ...
                  <div class="cs-flex cs-col-12 p-0 buy-product-last">
                     ...
                     <div class="cs-col-12 cs-col-md-5" style="margin-bottom: 10px; padding-top: 10px;">
                        ...
                        <b><span class="cm-red font-s-20 product-price" price="<?php echo $prod[0]['price'] ?>"><?php echo $prod[0]['price'] ?> </span></b> 
                     </div>
