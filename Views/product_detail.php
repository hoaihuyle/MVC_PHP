            ...
            <div class="cs-flex">
               <div class="cs-flex cs-col-lg-9 cs-wrap product-detail-left">
                  <div class="cs-col-lg-5 left-child">
                     ...
                     <div class="cs-flex flex-content-center" style="border-top: 1px #CCC solid; text-align: justify; line-height: 25px; margin-top: 10px; margin-bottom: 20px; padding-top: 10px;"> <i itemprop="description">MusclePharm BCAA 3:1:2 là sản phẩm cung cấp các chuỗi Amino Acid mà cơ thể không tự tổng hợp được. BCAA là nguyên liệu giúp cơ thể tạo ra tế bào cơ, thích hợp cho người chơi thể thạo, đặc biệt là thể hình. Bên cạnh đó, BCAA là thứ không thể thiếu trong quá trình tập luyện giảm mỡ cắt nét vì BCAA giúp cơ thể tránh mất đi cơ bắp.</i> </div>
                  </div>
                  <div class="cs-col-lg-7 mb-20 right-child">
                     ...
                     <div class="mt-10 cs-flex" style="width: 100%;">
                        <div style="line-height: 28px;">
                           ...
                           <div style="float: left;"> <span> Tình trạng:</span> <span class="status-display" status="0"> <span style="color: red; font-weight: 600">Ngừng kinh doanh</span></span> </div>
                     ...
                     <div class="title-cm mt-10 cm-red">
                        <span class="cm-red font-s-25 product-price" itemprop="offers" itemscope itemtype="http://schema.org/Offer" price="500000">
                           <span itemprop="price" class="cm-red" content="500000">500.000</span><span itemprop="priceCurrency" class="cm-red" content="VND">đ</span> 
                     ...
                     <div style="margin-top: 10px; line-height: 25px;">
                        <ul>
                           <li style="list-style: disclosure-open inside;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis, tempora reiciendis! Dolores unde dolorem atque optio delectus eligendi ratione labore sapiente maxime repudiandae illum, reprehenderit molestias? Sunt dolor quo fugiat.</li>
                        </ul>
                     </div>
                     ...
                     <div class="cs-flex mt-10"> <input class="spinner input-spin" name="quantity" value="1"> <button type="button" class="redirect-login" url="dang-nhap"><i class="far fa-heart"></i></button> </div>
                           <span class="cm-red font-s-25 product-price" style="margin-top: 13px; display: inline-block" price="500000">500.000₫ </span> 
                  ...
                  <div style="border-top: 1px #ada9a9 solid; padding-top: 20px; margin-top: 10px;">Xin quý khách lưu ý: Hình ảnh và Nutrition Facts chỉ mang tính chất tham khảo bởi thành phần, mẫu mã nhà sản xuất có thể thay đổi bất cứ lúc nào. Sản phẩm này không phải là thuốc và không có tác dụng thay thế thuốc chữa bệnh.</div>
                  <!-- One Tab --> 
                     ...
                     <div class="tab-content" style="padding-bottom: 0;">
                        <div id="fragment-1">
                           ...
                           <div class="detail_content">
                              ...
                              <h2><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><span style="color:#000000"><strong>C&ocirc;ng dụng của&nbsp;BCAA 3:1:2</strong></span></span></span></h2>
                              <p><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><span style="color:#000000">Với tỉ lệ c&acirc;n bằng l&yacute; tưởng 3:1:2 (L-Leucine : L-Valine : L-Isoleucine) cho 1 lần d&ugrave;ng, BCAA gi&uacute;p cơ thể tạo ra c&aacute;c tế b&agrave;o mới, ngăn chặn sự ph&aacute; hủy cơ.</span></span></span></p>
                              <p><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><span style="color:#000000">Leucine: k&iacute;ch th&iacute;ch cơ bắp ph&aacute;t triển v&agrave; tổng hợp c&aacute;c Protein trong cơ bắp, giảm tổn thương trong cơ khi tập luyện cường độ cao.</span></span></span></p>
                              <p><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><span style="color:#000000">Isoleucine: gi&uacute;p tạo ra Glucose cho cơ thể chuyển h&oacute;a th&agrave;nh năng lượng.</span></span></span></p>
                              <p><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><span style="color:#000000">Valine: giống như Leucine v&agrave; Isoleucine, Valine gi&uacute;p cho việc tổng hợp tế b&agrave;o cơ v&agrave; tạo ra năng lượng cho cơ bắp.</span></span></span></p>
                              <p><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><span style="color:#000000">Ho&agrave;n to&agrave;n kh&ocirc;ng c&oacute; chất b&eacute;o. C&aacute;ch d&ugrave;ng: d&ugrave;ng 2 vi&ecirc;n trong v&agrave; sau khi tập, 2 vi&ecirc;n giữa c&aacute;c bữa ăn.</span></span></span></p>
                              <h3><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><span style="color:#000000"><strong>C&aacute;ch sử dụng&nbsp;BCAA 3:1:2</strong></span></span></span></h3>
                              <p><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><span style="color:#000000">Mỗi ng&agrave;y c&aacute;c bạn uống 4 vi&ecirc;n trong đ&oacute;: 2 vi&ecirc;n uống v&agrave;o l&uacute;c trước v&agrave; trong khi tập, 2 vi&ecirc;n c&ograve;n lại uống v&agrave;o giữa c&aacute;c bữa ăn.</span></span></span></p>
                              <p><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><span style="color:#000000"><strong>BCAA 3:1:2 (30 Servings) </strong>l&agrave; một sản phẩm bổ sung c&aacute;c amino axit cần thiết cho cơ thể m&agrave; c&aacute;c bạn kh&ocirc;ng thể bỏ qu&aacute; khi tham gia tập luyện thể h&igrave;nh. Đ&acirc;y l&agrave; một sản phẩm l&yacute; tưởng gi&uacute;p cho cơ bắp của bạn được phục hồi v&agrave; ph&aacute;t triển tốt nhất. C&aacute;c bạn h&atilde;y đặt mua ngay để thực hiện h&oacute;a ước mơ c&oacute; một body đẹp, giảm mỡ sắc n&eacute;t, cơ bắp ph&aacute;t triển săn chắc của m&igrave;nh th&ocirc;i n&agrave;o!</span></span></span></p>
                           </div>
                        </div>
                     </div>
                     <!-- End One Tab --> 
                  ...
                  <div class="cs-flex cs-col-12 p-0 buy-product-last">
                     ...
                     <div class="cs-col-12 cs-col-md-5" style="margin-bottom: 10px; padding-top: 10px;">
                        ...
                        <b><span class="cm-red font-s-20 product-price" price="500000">500.000₫ </span></b> 
                     </div>
