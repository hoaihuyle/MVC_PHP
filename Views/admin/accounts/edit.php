                        ...
                        <form id="validationform" data-parsley-validate="" novalidate="" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input name="name_acco" type="text" required="" value="<?php echo $accountInfo[0]['name_acco'] ?>" class="form-control text-primary">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row text-right">
                                <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                    ...
                                    <button type="button" onclick="location.href='/account/index';" class="btn btn-space btn-secondary" >Quay về</button>
                                </div>
                            </div>
