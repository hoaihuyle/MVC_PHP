        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav" style="text-transform: uppercase;">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="admin/index" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>Menu <span class="badge badge-success">6</span></a>
                                 <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="/menu/index">Danh sách</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="admin/index" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-user-circle"></i>Danh mục sản phẩm <span class="badge badge-success">6</span></a>
                                 <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="/category/index">Danh sách</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/category/create">Thêm mới</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="admin/index" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fa fa-fw fa-user-circle"></i>Các hãng sản phẩm <span class="badge badge-success">6</span></a>
                                ...
                                <a class="nav-link" href="admin/index" data-toggle="collapse" aria-expanded="false" data-target="#submenu-6" aria-controls="submenu-6"><i class="fa fa-fw fa-user-circle"></i>Thống kê <span class="badge badge-success">6</span></a>
                                 <div id="submenu-6" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="/account/index">Đơn hàng bị bỏ rơi</a>
                                        </li> 
                                        <li class="nav-item">
                                            <a class="nav-link" href="/account/create">Kho hàng</a>
                                        </li> -->
                                        <!-- <li class="nav-item">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="admin/index" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fa fa-fw fa-user-circle"></i>Tài khoản <span class="badge badge-success">6</span></a>
